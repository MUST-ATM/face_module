...
def build_dataset(data_root, protocol):
    ...
    data_train = read_data(data_root, train_name, protocols, split='train', txt_type='folder', img_index='random')
    data_val = read_data(data_root, val_name, protocols, split='test', txt_type='folder', img_index='random')
    data_test = read_data(data_root, test_name, protocols, split='test', txt_type='folder', img_index='random')
