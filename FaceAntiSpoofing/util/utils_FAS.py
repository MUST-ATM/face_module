...
# def get_optimizer(optim_type, net, lr_init):
#     if optim_type == 'SGD':
#         optimizer = optim.SGD(filter(lambda p: p.requires_grad, net.parameters()), lr=lr_init, weight_decay=0.0005)
#     elif optim_type == 'Adam':
#         # optimizer = optim.Adam(itertools.chain(net.parameters(), net.parameters(), net.parameters()),
#         #                                 lr=args.lr_init, betas=(0.9, 0.999))
#         optimizer = optim.Adam(params=net.parameters(), lr=lr_init)
#     return optimizer
...
def get_Metrics_at_thr(probs, labels, thr):
    ...
    return HTER, AUC, Recall2, ACC, ACER, APCER, BPCER
