...
import app.face_module.FaceAntiSpoofing.trainers.clip as clip

from app.face_module.FaceAntiSpoofing.trainers.FAS_trainer import TrainerFAS
from app.face_module.FaceAntiSpoofing.util.utils_FAS import cross_entropy
